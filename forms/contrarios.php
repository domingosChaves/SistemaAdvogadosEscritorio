...
$.post({
        type:"POST",
        url:'cls/salvar/salvar_contrarios.php?nome='+nome+'&endereco='+endereco+'&numero='+numero+'&bairro='+bairro+'&cidade='+cidade+'&estado='+estado+'&cep='+cep+'&telefone='+telefone+'&celular='+celular+'&cpf='+cpf+'&cnpj='+cnpj+'&email='+email+'&obs='+obs,
        dataType:'text',
 ...
 <div style="border-bottom: solid 0.3px rgba(0,0,0,0.4); padding: 1%; width: 100%; text-align: center; font-size: 25px; margin-bottom: 1%">Contrários</div>
<form method="POST">
